...
<head>
  ...
  <title>Kelola Akun | Magang Admin</title>
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Daftar Akun Admin InternSheesh</h1>
          </div>
          <div class="row">
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered table-striped mb-0">
                      ...
                      <tbody>
                        @foreach ($magangadm as $item)    
                        <tr>
                          <td>{{ $magangadm->firstItem() + $loop->iteration-1 }}</td>
                          <td colspan="2">{{ $item->email }}</td>
                            <td>
                                @if ($item->role_id == 1)
                                  <strong>Admin Website</strong>
                                @else
                                  <strong>Admin Magang</strong>
                                @endif
                            </td>
                        </tr>
                        @endforeach
