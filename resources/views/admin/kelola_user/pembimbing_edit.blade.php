            ...
            <div class="col-lg-12 col-md-12 col-12 col-sm-12">
              ...
              <div class="card">
                <div class="card-header border-0">
                  <h4>Ubah Data Pembimbing</h4>
                </div>
                <form action="{{ route('pembimbing.updatedata',$data->id) }}" method="POST">
                  @csrf
                  @method('PUT')
                  <div class="card-body">
                    ...
                    <div class="form-outline mb-4 col-lg-12">
                      <label class="form-label" for="form1Example2">NIDN</label>
                      <input type="text" id="form1Example2" class="form-control" name="nidn" value="{{ $data->nidn }}"/>
                    </div>
                    <div class="form-outline mb-4 col-lg-12">
